...
OUT = ROOT.parent
PACKAGE = OUT / "student_samed_platform_ui_v15_stable_ux_footer.zip"
CHECKSUMS = OUT / "student_samed_streamlit_v15_checksums.txt"
...
def main() -> None:
    ...
    required = [
        ...
        f"{prefix}/RELEASE_V15_AR.txt",
        f"{prefix}/scripts/streamlit_ui_v15_stub_qa.py",
        f"{prefix}/scripts/streamlit_dashboard_v15_browser_qa.js",
        f"{prefix}/scripts/dashboard_component_harness_v15.html",
        f"{prefix}/previews/streamlit_dashboard_v15_desktop.png",
        f"{prefix}/previews/streamlit_dashboard_v15_mobile.png",
    ...
    files = [
        PACKAGE,
        ROOT / "previews" / "streamlit_dashboard_v15_desktop.png",
        ROOT / "previews" / "streamlit_dashboard_v15_mobile.png",
    ]
    lines = ["STREAMLIT_UI_V15_STABLE_UX_FOOTER_RELEASE", ""]
    for path in files:
    ...
    print("STREAMLIT_UI_V15_STABLE_UX_FOOTER_BUILT")
